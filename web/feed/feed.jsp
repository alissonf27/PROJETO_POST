...
<html>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <!-- Blog Entries Column -->
        <div class="col-md-8 border-right" style="padding-top: 10px;">
        	<br>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                  <input type="text" id="title-post" class="form-control" placeholder="Titulo do post...">
                </div>

                <div class="form-group">
                  <textarea type="text" id="content-post" class="form-control" placeholder="Conteúdo do post..."></textarea>
                </div>

                <div class="form-group">
                  <input type="date" id="data-criacao" class="form-control" placeholder="Data de criação">
                </div>
              </div>
